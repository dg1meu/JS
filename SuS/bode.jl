...
# ╔═╡ 539bd7d2-551d-11ed-2715-e53a2ec55fe2
using ControlSystems, Plots;

# ╔═╡ 7801a0e7-aeab-47c4-9dfe-a824cb6b7ab2
setPlotScale("dB")

# ╔═╡ 0e55366e-496c-4b9e-97e5-76e2a104c69d
default(minorgrid=true,minorgridalpha=0.1,gridalpha=0.5)

# ╔═╡ 99fab6f4-2a71-4828-8bea-3f083d24b33c
md"""
 # Elementare LTI Systeme

P-Glied: Proportionalglied\
D-Glied: Differentierer\
I-Glied: Integrierer\
PT1-Glied: Tiefpass 1. Ordnung\
PT2-Glied: Tiefpass 2. Ordnung\
"""

# ╔═╡ cda0ce66-7329-4656-bfe0-fedcd0b1d0fb
md"""
Gliedart einstellen:
"""

# ╔═╡ a7bcc0c2-a121-4237-a26f-1e2868df9399
Glied = "P"

# ╔═╡ 14e6f307-7e5e-4896-aec0-daa0e4be2fff
md"""
Weitere Parameter einstellen, Proportionalitätsfaktor/beiwert K, Zeitkonstante T (PT*), Dämpfung ϑ (PT2)
"""

# ╔═╡ 40769a43-0b38-4b86-82c3-90cc61820b17
K = 2; T = 2; ϑ=0.5

# ╔═╡ 7d81f5e8-e31a-424c-891e-96e65b6a1142
md"""
## Definition der Transferfunktionen in einer Funktion
ändert sich bei Änderung von "Glied"
"""

# ╔═╡ f7051ae1-54ab-450d-a18a-f856e998df2d
function transfer(Glied)
	Glied == "P" && (H = tf(K))
	Glied == "D" && (H = tf([K,0],[1]))
	Glied == "I" && (H = tf([K],[1,0]))
	Glied == "PT1" && (H = tf([K],[T,1]))
	Glied == "PT2" && (H = tf([K],[T^2,2*ϑ*T,1]))
	return H
end

# ╔═╡ 74551ac2-5d81-4a9b-8b33-742a2eebd2d8
H = transfer(Glied)

# ╔═╡ 17177a88-9985-44bf-a6b9-d3e6cf531203
pzmap(H, xlim=(-2, 2), ylim=(-2, 2))

# ╔═╡ 9ee46c45-270d-43cd-a948-1fa948e96caf
md"""
### Bodediagram / plot
"""

# ╔═╡ 7bf99f7a-e53e-4317-98fe-af5b5d2d26c3
bodeplot(H,minorgrid=true,minorgridalpha=0.1,gridalpha=0.5)

# ╔═╡ b0d71e99-1429-4fb2-927d-30e30990b485
plot(impulse(H), title="Impulse response / Impulsantwort")

# ╔═╡ 24837c39-0d00-4bc6-84e7-88470e3d0c55
plot(step(H), title="Step response / Sprungantwort")
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "c8dc77c9617bf95805dfe2c700156d50e9e9e3b5"
...
git-tree-sha1 = "3d4e52ad928c774bd9007a6aaf0e108e97061e41"
...
git-tree-sha1 = "62b252d7993067154c0fb5c345842df0194c3e3b"
...
git-tree-sha1 = "06587f44cbd1ffe0ecfb472925c9b875cbe880cd"
...
git-tree-sha1 = "7b72bb32b2bdf5b7c9365aa9a7001e15a84a9c2c"
